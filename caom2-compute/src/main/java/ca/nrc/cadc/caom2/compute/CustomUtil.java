...
public final class CustomUtil {
    ...
    // TODO: There will be a compute function of some sort
//    public static "Custom" compute(Set<Artifact> artifacts) {
...
//                                Interval s = CustomUtil.toInterval(c.custom, function);
...
//                            CoordFunction1D function = c.custom.getAxis().function;
//
//                            numPixels += Util.getNumPixels(c.custom.getAxis());
//                            if (range != null) {
//                                Interval si = toInterval(c.custom, range);
//                                totSampleSize += si.getUpper() - si.getLower();
//                            } else if (bounds != null) {
//                                for (CoordRange1D cr : bounds.getSamples()) {
//                                    Interval si = toInterval(c.custom, cr);
//                                    totSampleSize += si.getUpper() - si.getLower();
//                                }
//                            } else if (function != null) {
//                                Interval si = CustomUtil.toInterval(c.custom, function);
//                                totSampleSize += si.getUpper() - si.getLower();
//                            }
//                        }
//                    }
