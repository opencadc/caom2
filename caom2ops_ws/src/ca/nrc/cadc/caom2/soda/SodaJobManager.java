...
{
    private static final Logger log = Logger.getLogger(SodaJobManager.class);
    ...
    private final JobDAO.JobSchema config;
    ...
    public SodaJobManager()
    {
        ...
        JobExecutor jobExec = new ThreadPoolExecutor(jobPersist, SodaJobRunner.class, 6);
    ...
    public JobDAO.JobSchema getConfig()
    {
        return config;
    }
}
