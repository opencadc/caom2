...
public class CollectionReadGroupsTest {

    private static final Logger log = Logger.getLogger(CollectionReadGroupsTest.class);

    public CollectionReadGroupsTest() {
        Log4jInit.setLevel("ca.nrc.cadc.caom", Level.INFO);
        Log4jInit.setLevel("ca.nrc.cadc.util", Level.INFO);
    }
    
    @Test
    public void testCollectionReadGroups() {
        ...
        try {
            ...
            CollectionReadGroups config = new CollectionReadGroups("A1", "collection-read-groups.properties");
            ...
            config = new CollectionReadGroups("A2", "collection-read-groups.properties");
