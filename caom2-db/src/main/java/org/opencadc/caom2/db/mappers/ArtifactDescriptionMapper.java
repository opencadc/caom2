 ...
 * @author pdowler
 */
public class ArtifactDescriptionMapper implements RowMapper<ArtifactDescription> {
    private static final Logger log = Logger.getLogger(ArtifactDescriptionMapper.class);
    private final Calendar utcCalendar = Calendar.getInstance(DateUtil.UTC);

    public static String[] COLUMNS = new String[] {
        "uri", "description", 
        "lastModified", "metaChecksum", "metaProducer",
        "id" // PK
    };

    public ArtifactDescriptionMapper() {
    }
    
    public ArtifactDescription mapRow(ResultSet rs, int row)
            throws SQLException {
        int col = 1;
