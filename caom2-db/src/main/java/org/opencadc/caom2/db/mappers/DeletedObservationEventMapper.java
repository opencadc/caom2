 ...
 * @author pdowler
 */
public class DeletedObservationEventMapper implements RowMapper<DeletedObservationEvent> {
    private static final Logger log = Logger.getLogger(DeletedObservationEventMapper.class);
    ...
    public DeletedObservationEventMapper() {
    }
    
    public DeletedObservationEvent mapRow(ResultSet rs, int row)
        throws SQLException {
        int col = 1;
