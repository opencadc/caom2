...
--    position_axis_function text,
    ...
    custom_axis_axis_ctype varchar(16),
    custom_axis_axis_cunit varchar(16),
    custom_axis_error_syser double precision,
    custom_axis_error_rnder double precision,
    custom_axis_range_start_pix double precision,
    custom_axis_range_start_val double precision,
    custom_axis_range_end_pix double precision,
    custom_axis_range_end_val double precision,
    custom_axis_bounds text,
    custom_axis_function_naxis bigint,
    custom_axis_function_refCoord_pix double precision,
    custom_axis_function_refCoord_val double precision,
    custom_axis_function_delta double precision,
