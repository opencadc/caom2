 ...
 *
 */
public class ValidatorWithResourceID extends TapBasedValidator {
    
    public static final String STATE_CLASS = Artifact.class.getSimpleName();
    
    private URI caomTapResourceID;
        
    private static final Logger log = Logger.getLogger(ValidatorWithResourceID.class);
    
    public ValidatorWithResourceID(URI caomTapResourceID, 
