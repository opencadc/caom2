 ...
 *
 */
public class Validator extends ArtifactValidator {
    ...
    public Validator(DataSource dataSource, String[] dbInfo, ObservationDAO observationDAO, 
    ...
    public Validator(URI caomTapResourceID, 
            String collection, boolean reportOnly, ArtifactStore artifactStore) {
        super(collection, reportOnly, artifactStore);
        this.caomTapResourceID = caomTapResourceID;
    }
    
    public Validator(URL caomTapURL, 
            String collection, boolean reportOnly, ArtifactStore artifactStore) {
        super(collection, reportOnly, artifactStore);
