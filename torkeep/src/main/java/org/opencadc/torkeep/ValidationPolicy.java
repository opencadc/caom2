...
public class ValidationPolicy {
    private static final Logger log = Logger.getLogger(ValidationPolicy.class);

    private final Set<String> vmap = new TreeSet<>();
    
    public ValidationPolicy(List<String> validationPolicy) {
        this.vmap.addAll(validationPolicy);
    }
    
    private class ValidationVisitor implements EntityVisitor {
