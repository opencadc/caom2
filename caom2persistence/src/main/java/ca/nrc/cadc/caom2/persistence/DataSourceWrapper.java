...
/**
 * A simple DataSource wrapper that calls setCatalog on a Connection before
 * returning it. This is usually necessary to avoid creating a cross-database
 * transaction if the DataSource is not connected to the target database
 * already, such as when a connection pool that accesses multiple databases is
 * used.
 *
 * @author pdowler
 */
