 ...
 * @author pdowler
 */
public class DatabaseReadAccessDAOTest
{
    ...
    protected DatabaseReadAccessDAOTest(Class genClass, String server, String database, String schema, boolean deletionTrack)
        throws Exception
    {
