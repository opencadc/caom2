 ...
 * @author pdowler
 */
public class Sia2ErrorTest extends SyncUWSTest
{
    private static final Logger log = Logger.getLogger(Sia2ErrorTest.class);
    ...
    public Sia2ErrorTest() 
    { 
        super(URI.create("ivo://cadc.nrc.ca/sia"), Standards.SIA_QUERY_20);
        
        File testFile = FileUtil.getFileFromResource("SyncTest-ERROR-BAND.properties", Sia2ErrorTest.class);
        if (testFile.exists())
        {
