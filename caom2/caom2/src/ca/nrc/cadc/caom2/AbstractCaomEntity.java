...
public  class AbstractCaomEntity implements CaomEntity, Serializable
{
    ...
    private static final String CAOM2 = AbstractCaomEntity.class.getPackage().getName();
    ...
    public boolean equals(Object o)
    {
        ...
        if (o == null)
            return false;
        if (o instanceof AbstractCaomEntity)
        {
            AbstractCaomEntity a = (AbstractCaomEntity) o;
        ...
        throws IllegalAccessException
    {
        ...
        while (sc != null && !AbstractCaomEntity.class.equals(sc))
        {
