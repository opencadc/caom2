...
public class CoordAxis2D {
    ...
    // mutable state
    public CoordError error1;
    public CoordError error2;
    public CoordRange2D range;
    public CoordBounds2D bounds;
    public CoordFunction2D function;
