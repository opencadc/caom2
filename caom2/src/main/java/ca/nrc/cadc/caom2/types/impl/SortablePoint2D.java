 ...
 * 
 * <p>Note: in order to deal with the difference behavior of double and Double with respect to -0.0 and +0.0, the SortablePoint2D constructor converts any
 * coordinates that are -0.0 to +0.0.
 * 
 * <p>For additional documentation, see <a href="http://algs4.cs.princeton.edu/12oop">Section 1.2</a> of <i>Algorithms, 4th Edition</i> by Robert Sedgewick and
 * Kevin Wayne.
 *
...
public final class SortablePoint2D implements Comparable<SortablePoint2D>, Serializable {
     ...
     *             if either <tt>x</tt> or <tt>y</tt> is <tt>Double.NaN</tt>, <tt>Double.POSITIVE_INFINITY</tt> or <tt>Double.NEGATIVE_INFINITY</tt>
     */
     ...
     * @param that
     *            the other point
     * @return the value <tt>0</tt> if this string is equal to the argument string (precisely when <tt>equals()</tt> returns <tt>true</tt>); a negative integer
     *         if this point is less than the argument point; and a positive integer if this point is greater than the argument point
     */
    ...
    private class PolarOrder implements Comparator<SortablePoint2D>, Serializable {
        ...
        public int compare(SortablePoint2D q1, SortablePoint2D q2) {
            ...
            if (dy1 >= 0 && dy2 < 0) {
                ...
                return -ccw(SortablePoint2D.this, q1, q2); // both above or below
            }
