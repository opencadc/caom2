...
public class CaomIDGenerator implements Serializable
{
    ...
    /**
     * Get the singleton instance of the generator. This is used by CaomEntity constructors
     * to assign IDs.
     * 
     * @return an IDGenerator
     */
    public static CaomIDGenerator getInstance() { return instance; }
    ...
    public Long generateID()
    {
        ...
        if (t == prev) // check for duplicate in case sleep above is not quite enough
