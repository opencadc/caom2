 ...
 * @author pdowler
 */
public class ArtifactAccessReader {
    private static final Logger log = Logger.getLogger(ArtifactAccessReader.class);
    ...
    public ArtifactAccess read(String xml)  throws IOException {
        return read(new StringReader(xml));
    }
    
    public ArtifactAccess read(InputStream istream)  throws IOException {
