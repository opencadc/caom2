...
public abstract class Harvester implements Runnable
{
    ...
    protected Map<String,Object> getConfigDAO(String[] desc)
        throws IOException
    {
    ...
    /**
     * @param ds DataSource from the destination DAO class
     * @param c class being persisted via the destination DAO class
     */
