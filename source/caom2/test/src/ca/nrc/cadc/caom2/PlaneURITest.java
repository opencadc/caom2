...
public class PlaneURITest 
{
    ...
    public void testConstructor()
    {
        try
        {
            ...
            try
            {
                p = new PlaneURI(null, "Shiny New Product");
                Assert.fail("expected IllegalArgumentException for observationURI=null");
            }
            catch(IllegalArgumentException expected) { log.debug("expected: " + expected); }

            try
            {
                p = new PlaneURI(o, "Shiny/New/Product");
