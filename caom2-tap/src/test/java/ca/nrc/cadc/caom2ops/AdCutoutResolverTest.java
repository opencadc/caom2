 ...
 * @author yeunga
 */
public class AdCutoutResolverTest {
    private static final Logger log = Logger.getLogger(AdCutoutResolverTest.class);
    ...
    AdCutoutResolver adResolver = new AdCutoutResolver();

    public AdCutoutResolverTest() {
