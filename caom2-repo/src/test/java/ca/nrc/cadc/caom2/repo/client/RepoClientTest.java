...
public class RepoClientTest {
	...
	try {
	    ...
	    Assert.assertEquals(list.get(0).getID().toString(), "00000000-0000-0000-897c-013ac26a8f32");
	    Assert.assertEquals(list.get(1).getID().toString(), "00000000-0000-0000-31a6-013ac26a8284");
	    Assert.assertEquals(list.get(2).getID().toString(), "00000000-0000-0000-7a3c-013ac28ebeca");
	    Assert.assertEquals(list.get(3).getID().toString(), "00000000-0000-0000-95c3-01394aa6a272");
	    Assert.assertEquals(list.get(4).getID().toString(), "00000000-0000-0000-8117-013ac28ddb9b");
	    ;
