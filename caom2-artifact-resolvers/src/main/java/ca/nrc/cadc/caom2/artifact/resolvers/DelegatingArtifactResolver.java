...
/**
 * Delegating StorageResolver that requires configuration in 
 * <code>${user.home}/config/caom2-artifact-resolvers.properties</code>. This 
 * implementation is CaomArtifactResolver but without the default configuration.
 * 
 * @author pdowler
 */
public class DelegatingArtifactResolver extends CaomArtifactResolver implements StorageResolver {
    ...
    private static final File CONFIG_FILE = new File(System.getProperty("user.home")
            + "/config/caom2-artifact-resolvers.properties");
    ...
    public String toString() {
        ...
        for (Map.Entry<String,StorageResolver> me : handlers.entrySet()) {
            sb.append(me.getKey()).append("=").append(me.getValue().getClass().getName());
            sb.append(", ");
        }
        sb.append("]");
        return sb.toString();
