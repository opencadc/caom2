...
public class CaomArtifactResolverTest {
    ...
    public void testDefaultConfig() {
        try {
            new CaomArtifactResolver();
        } catch (Exception unexpected) {
            log.error("unexpected exception", unexpected);
            Assert.fail("failed to load the default config file: " + CaomArtifactResolver.class.getSimpleName() + ".properties.default");
        }
    }
    ...
    public void testWrongConfig() {
        try {
            URL url = CaomArtifactResolver.class.getClassLoader().getResource(WRONG_CONFIG);
            new CaomArtifactResolver(url);
