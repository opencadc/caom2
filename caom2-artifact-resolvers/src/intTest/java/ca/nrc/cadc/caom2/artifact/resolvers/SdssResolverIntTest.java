...
public class SdssResolverIntTest {
    private static final URI VALID_URI =
        URI.create("sdss:eboss/spectro/redux/v5_10_0/spectra/8218/spec-8218-57519-0017.fits");
    ...
    public SdssResolverIntTest() {
    }


    @Test
    public void testValidSiteUrl() {
        LOGGER.info("Starting SDSS testValidSiteUrl");

        final URL url = resolver.toURL(VALID_URI);
        ...
        LOGGER.info("response code: " + head.getResponseCode());
    }
}
