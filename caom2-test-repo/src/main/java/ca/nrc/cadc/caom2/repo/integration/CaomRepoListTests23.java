 ...
 * @author majorb
 */
public class CaomRepoListTests23 extends CaomRepoBaseIntTests {

    private static final Logger log = Logger.getLogger(CaomRepoListTests23.class);
     ...
     */
    public CaomRepoListTests23(URI resourceID, String pem1, String pem2, String pem3) {
