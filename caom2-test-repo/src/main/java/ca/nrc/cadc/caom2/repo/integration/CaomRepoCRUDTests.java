 ...
 *
 */
public class CaomRepoCRUDTests extends CaomRepoIntTests
{
    
    private static final Logger log = Logger.getLogger(CaomRepoCRUDTests.class);
     ...
     */
    public CaomRepoCRUDTests(URI resourceID, String pem1, String pem2, String pem3) 
    { 
