...
/**
 * Test that a table typical of TAP-1.0 output can be uploaded and queried.
 * @author pdowler
 */
public class UploadTable10 extends TapSyncUploadTest
{
    private static final Logger log = Logger.getLogger(UploadTable10.class);
