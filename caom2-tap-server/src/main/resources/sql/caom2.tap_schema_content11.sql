...
( 'caom2.Artifact', 'accessURL',     'access URL for the complete file', NULL, NULL, NULL, 'char', NULL,'clob', 0,0,0, 8),
...
( 'caom2.SIAv1', 'position_bounds', 	'spatial bounds of the data', 				NULL, 'deg', 			'double', '*', 'polygon', 1,1,0 ),
